...
def cabecalho_por_pagina(l, sh):
    #Linha 1 Cabeçalho
        ...
        sh.cell(row= l, column= 1).font = styles.Font(bold=True, name= 'Calibri', size= 9)
        ...
        sh.cell(row= l, column= 6).font = styles.Font(bold=True, name= 'Calibri', size= 9)
        ...
        sh.cell(row= l, column= 18).font = styles.Font(bold=True, name= 'Calibri', size= 9)
        ...
        sh.cell(row= l, column= 27).font = styles.Font(bold=True, name= 'Calibri', size= 9)
        ...
        sh.cell(row= l, column= 22).font = styles.Font(bold=True, name= 'Calibri', size= 9)
        ...
        sh.cell(row= l, column= 26).font = styles.Font(bold=True, name= 'Calibri', size= 9)
        ...
        for i in range(6, 26, 1):
            ...
            sh.cell(row= l, column= i).font = styles.Font(bold=True, name= 'Calibri', size= 9)
...
def turma_integral_terceiro(request):
    ...
    wb = load_workbook(filename= str(settings.BASE_DIR) + '/aplicacoes/dinem/relatorios/turma_integral_terceiro_2022.xlsx')
    sh = wb['Relatório Final-3ª Integral']
    ...
    sh.cell(row= 1, column= 11).font = styles.Font(bold=True, name= 'Calibri', size= 12)
    ...
    sh.cell(row= 3, column= 15).value = (sh.cell(row= 3, column= 15).value).replace('variavel_turno', turma.turno)

    # Dados de Carga Horária
    sh.cell(row= 8, column= 6).value = '120h'
    sh.cell(row= 8, column= 6).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    sh.cell(row= 8, column= 9).value = '80h'
    sh.cell(row= 8, column= 9).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    sh.cell(row= 8, column= 10).value = '120h'
    sh.cell(row= 8, column= 10).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    sh.cell(row= 8, column= 18).value = '200h'
    sh.cell(row= 8, column= 18).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    sh.cell(row= 8, column= 20).value = '40h'
    sh.cell(row= 8, column= 20).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    sh.cell(row= 8, column= 21).value = '80h'
    sh.cell(row= 8, column= 21).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    sh.cell(row= 8, column= 28).value = '880h'
    sh.cell(row= 8, column= 28).alignment = styles.Alignment(horizontal='center', vertical= 'center')

    # #Dados do Aluno
    sh.row_dimensions[8].height = 17
    ...
    for relatorio in relatorios:
        ...
        if relatorio.resultado == 'TRANSFERIDO':
            ...
            sh.cell(row= l, column= 18).value = relatorio.estudo_orientado
            sh.cell(row= l, column= 19).value = '-'
            sh.cell(row= l, column= 20).value = '-'
            sh.cell(row= l, column= 21).value = relatorio.pos_medio
            sh.cell(row= l, column= 22).value = '-'
            sh.cell(row= l, column= 23).value = '-'
            sh.cell(row= l, column= 24).value = '-'
            sh.cell(row= l, column= 25).value = '-'
            sh.cell(row= l, column= 26).value = '-'
            sh.cell(row= l, column= 27).value = '-'
            if relatorio.formacao_tecnica != '-':
                sh.cell(row= l, column= 38).value = relatorio.formacao_tecnica
                sh.cell(row= l, column= 28).value = '-'
                sh.cell(row= l, column= 29).value = '-'
                sh.cell(row= l, column= 30).value = '-'
                sh.cell(row= l, column= 31).value = '-'
                sh.cell(row= l, column= 32).value = '-'
                sh.cell(row= l, column= 33).value = '-'
                sh.cell(row= l, column= 34).value = '-'
                sh.cell(row= l, column= 35).value = '-'
                sh.cell(row= l, column= 36).value = '-'
            else:
                sh.cell(row= l, column= 38).value = '-'
                sh.cell(row= l, column= 28).value = relatorio.linguagens_tecnologias
                sh.cell(row= l, column= 29).value = relatorio.linguagens_tecnologias
                sh.cell(row= l, column= 30).value = relatorio.ciencias_humanas
                sh.cell(row= l, column= 31).value = relatorio.ciencias_humanas
                sh.cell(row= l, column= 32).value = relatorio.ciencias_humanas
                sh.cell(row= l, column= 33).value = relatorio.ciencias_natureza
                sh.cell(row= l, column= 34).value = relatorio.ciencias_natureza
                sh.cell(row= l, column= 35).value = relatorio.matematica
                sh.cell(row= l, column= 36).value = relatorio.matematica
            sh.cell(row= l, column= 37).value = '-'
            ...
            if relatorio.resultado == 'APROVADO':
                ...
                resultado = 'RP'
            sh.cell(row= l, column= 39).value = resultado
        ...
        sh.cell(row= l, column= 28).alignment = styles.Alignment(horizontal='center', vertical= 'center')
        sh.cell(row= l, column= 29).alignment = styles.Alignment(horizontal='center', vertical= 'center')
        sh.cell(row= l, column= 30).alignment = styles.Alignment(horizontal='center', vertical= 'center')
        sh.cell(row= l, column= 31).alignment = styles.Alignment(horizontal='center', vertical= 'center')
        sh.cell(row= l, column= 32).alignment = styles.Alignment(horizontal='center', vertical= 'center')
        sh.cell(row= l, column= 33).alignment = styles.Alignment(horizontal='center', vertical= 'center')
        sh.cell(row= l, column= 34).alignment = styles.Alignment(horizontal='center', vertical= 'center')
        sh.cell(row= l, column= 35).alignment = styles.Alignment(horizontal='center', vertical= 'center')
        sh.cell(row= l, column= 36).alignment = styles.Alignment(horizontal='center', vertical= 'center')
        sh.cell(row= l, column= 37).alignment = styles.Alignment(horizontal='center', vertical= 'center')
        sh.cell(row= l, column= 38).alignment = styles.Alignment(horizontal='center', vertical= 'center')
        sh.cell(row= l, column= 39).alignment = styles.Alignment(horizontal='center', vertical= 'center')

        l += 1
        ordem += 1
        contador += 1

        if contador == 30 and not paginas:
            paginas = True
            print(ordem)
    ...
    for i in range(9, l+3, 1):
        ...
        sh.cell(row= i, column= 28).border = styles.Border(top=double, left=thin, right=thin, bottom=double)
        sh.cell(row= i, column= 29).border = styles.Border(top=double, left=thin, right=thin, bottom=double)
        sh.cell(row= i, column= 30).border = styles.Border(top=double, left=thin, right=thin, bottom=double)
        sh.cell(row= i, column= 31).border = styles.Border(top=double, left=thin, right=thin, bottom=double)
        sh.cell(row= i, column= 32).border = styles.Border(top=double, left=thin, right=thin, bottom=double)
        sh.cell(row= i, column= 33).border = styles.Border(top=double, left=thin, right=thin, bottom=double)
        sh.cell(row= i, column= 34).border = styles.Border(top=double, left=thin, right=thin, bottom=double)
        sh.cell(row= i, column= 35).border = styles.Border(top=double, left=thin, right=thin, bottom=double)
        sh.cell(row= i, column= 36).border = styles.Border(top=double, left=thin, right=thin, bottom=double)
        sh.cell(row= i, column= 37).border = styles.Border(top=double, left=thin, right=thin, bottom=double)
        sh.cell(row= i, column= 38).border = styles.Border(top=double, left=thin, right=thin, bottom=double)
        sh.cell(row= i, column= 39).border = styles.Border(top=double, left=thin, right=thin, bottom=double)

    wb.remove(wb['Plan1'])

    response = HttpResponse(content_type='application/vnd.ms-excel')
    response['Content-Disposition'] = 'attachment; filename="Turma Integral 3ª Série.xlsx"'
