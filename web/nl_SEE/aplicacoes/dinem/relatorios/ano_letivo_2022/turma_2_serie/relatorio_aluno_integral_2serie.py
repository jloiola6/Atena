...
def dados_aluno_integral_2serie(request, id_aluno_turma):
    urls = str(settings.BASE_DIR)

    # Abre o arquivo pelo caminho do documento.
    wb = load_workbook(filename= urls + '/aplicacoes/dinem/relatorios/ano_letivo_2022/turma_2_serie/relatorio_aluno_integral_2serie_2022.xlsx')
    ...
    print(endereco.escola.nome_escola)
    ...
    sh.cell(row= 31, column= 4).value = (sh.cell(row= 31, column= 4).value).replace('relatorio1.pj_vd', relatorio1.projeto_vida)
    sh.cell(row= 31, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 32, column= 4).value = (sh.cell(row= 32, column= 4).value).replace('relatorio1.ofic_ling', relatorio1.oficina_linguagens)
    sh.cell(row= 32, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 33, column= 4).value = (sh.cell(row= 33, column= 4).value).replace('relatorio1.ofic_mat', relatorio1.oficina_matematica)
    sh.cell(row= 33, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 34, column= 4).value = (sh.cell(row= 34, column= 4).value).replace('relatorio1.ofic_natureza', relatorio1.oficina_natureza)
    sh.cell(row= 34, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 35, column= 4).value = (sh.cell(row= 35, column= 4).value).replace('relatorio1.ofic_humanas', relatorio1.oficina_humanas)
    sh.cell(row= 35, column= 4).font = styles.Font(name= 'Calibri', size= 9)
    ...
    sh.cell(row= 30, column= 6).value = (sh.cell(row= 30, column= 6).value).replace('relatorio2.espanhol', relatorio2.espanhol)
    sh.cell(row= 30, column= 6).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 31, column= 6).value = (sh.cell(row= 31, column= 6).value).replace('relatorio2.pj_vd', relatorio2.projeto_vida)
    sh.cell(row= 31, column= 6).font = styles.Font(name= 'Calibri', size= 9)


    sh.cell(row= 36, column= 6).value = (sh.cell(row= 36, column= 6).value).replace('relatorio2.ling_tec', relatorio2.linguagens_tecnologias)
    ...
    sh.cell(row= 37, column= 6).value = (sh.cell(row= 37, column= 6).value).replace('relatorio2.mat_tec', relatorio2.matematica_tecnologias)
    ...
    sh.cell(row= 38, column= 6).value = (sh.cell(row= 38, column= 6).value).replace('relatorio2.cien_nat', relatorio2.ciencias_natureza)
    sh.cell(row= 38, column= 6).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio2.ciencias_natureza != '-':
        sh.cell(row= 38, column= 7).value = '240'
        sh.cell(row= 38, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    else:
        sh.cell(row= 38, column= 7).value = '-'
        sh.cell(row= 38, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')

    sh.cell(row= 39, column= 6).value = (sh.cell(row= 39, column= 6).value).replace('relatorio2.cien_hum', relatorio2.ciencias_humanas)
    sh.cell(row= 39, column= 6).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio2.ciencias_humanas != '-':
        sh.cell(row= 39, column= 7).value = '240'
        sh.cell(row= 39, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    else:
        sh.cell(row= 39, column= 7).value = '-'
        sh.cell(row= 39, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')

    sh.cell(row= 40, column= 6).value = (sh.cell(row= 40, column= 6).value).replace('relatorio2.form_prof', relatorio2.formacao_tecnica)
    sh.cell(row= 40, column= 6).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio2.formacao_tecnica != '-':
        sh.cell(row= 40, column= 7).value = '480'
        sh.cell(row= 40, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    else:
        sh.cell(row= 40, column= 7).value = '-'
        sh.cell(row= 40, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')


    c = 0
    for i in range(50, 52, 1):
        sh.cell(row= i, column= 5).value = (sh.cell(row= i, column= 5).value).replace('NOME DA ESCOLA', endereco.escola.nome_escola)
    ...
    response['Content-Disposition'] = 'attachment; filename="Aluno Integral 2ª Série.xlsx"'
