// Script para controlar a busca de imagens
    ...
    const buscaPorNome = (evento) => {
        ...
        containersNav.forEach((container) => {
            if(!container.classList.contains('oculto')){
                const mensagemSemDoucumento = container.querySelector('[data-sem-imagens]')
                ...
                if(mensagemSemDoucumento == null){
                    ...
                    const containersResultados = container.querySelectorAll('[data-imagem-resultado]')
                    ...
                    if(textoVazio){
                        ...
                        let resultados = 0
                        containersResultados.forEach((container) => {
                            const nome = container.getAttribute('data-imagem-resultado').toLowerCase()
