(() => {
    const containerPai = document.querySelector('[data-container-inputs]')
    ...
    const FormularioGrupo = (contador) => {
        const html = `
            <div>
                <input class="campo-arquivo" id="arquivo" type="file" accept=".png, .jpeg, .jpg" name="arquivo${contador}" required>
