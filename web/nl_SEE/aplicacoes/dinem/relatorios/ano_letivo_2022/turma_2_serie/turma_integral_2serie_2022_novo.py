...
def cabecalho_por_pagina(l, sh):
    #Linha 1 Cabeçalho
        ...
        sh.cell(row= l, column= 33).value = sh.cell(row= 4, column= 33).value
        sh.cell(row= l, column= 33).font = styles.Font(bold=True, name= 'Calibri', size= 12)
        sh.cell(row= l, column= 33).alignment = styles.Alignment(textRotation=90, horizontal='center', vertical= 'center')
        ...
        sh.cell(row= l, column= 28).value = sh.cell(row= 5, column= 28).value
        sh.cell(row= l, column= 28).font = styles.Font(bold=True, name= 'Calibri', size= 12)
        sh.cell(row= l, column= 28).alignment = styles.Alignment(wrap_text= True, horizontal='center', vertical= 'center')

        sh.cell(row= l, column= 32).value = sh.cell(row= 5, column= 32).value
        sh.cell(row= l, column= 32).font = styles.Font(bold=True, name= 'Calibri', size= 12)
        sh.cell(row= l, column= 32).alignment = styles.Alignment(wrap_text= True, horizontal='center', vertical= 'center')
        sh.row_dimensions[l].height = 29
        l += 1

        #Linha 3 Cabeçalho
        sh.cell(row= l, column= 1).value = sh.cell(row= 7, column= 1).value
        for i in range(5, 33, 1):
            sh.cell(row= l, column= i).value = sh.cell(row= 7, column= i).value
        ...
        #Diversificada
        sh.merge_cells(f'R{l-1}:AA{l-1}')
        #Itinerarios
        sh.merge_cells(f'R{l-2}:AF{l-2}')
        #Formação Tecnica
        sh.merge_cells(f'AF{l-1}:AF{l-1}')
        #Resultado
        sh.merge_cells(f'AG{l-2}:AG{l}')
        #Rotas
        sh.merge_cells(f'AB{l-1}:AE{l-1}')
...
def turma_integral_2serie(request):
    ...
    wb = load_workbook(filename= str(settings.BASE_DIR) + '/aplicacoes/dinem/relatorios/ano_letivo_2022/turma_2_serie/turma_integral_2serie_2022_novo.xlsx')
    ...
    sh.cell(row= 3, column= 19).value = (sh.cell(row= 3, column= 19).value).replace('variavel_turno', turma.turno)
    ...
    for relatorio in relatorios:
        ...
        if relatorio.resultado == 'TRANSFERIDO':
            ...
            sh.cell(row= l, column= 7).value = relatorio.arte
            sh.cell(row= l, column= 8).value = relatorio.ingles
            ...
            sh.cell(row= l, column= 29).value = relatorio.ciencias_humanas
            sh.cell(row= l, column= 30).value = relatorio.matematica_tecnologias
            sh.cell(row= l, column= 31).value = relatorio.ciencias_natureza
            sh.cell(row= l, column= 32).value = relatorio.formacao_tecnica
            ...
            if relatorio.resultado == 'APROVADO':
                ...
                resultado = 'RP'
            sh.cell(row= l, column= 33).value = resultado
