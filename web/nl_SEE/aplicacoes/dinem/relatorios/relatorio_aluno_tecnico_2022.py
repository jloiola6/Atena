...
def dados_aluno_tecnico(request, id_aluno_turma):
    urls = str(settings.BASE_DIR)

    # Abre o arquivo pelo caminho do documento.
    wb = load_workbook(filename= urls + '/aplicacoes/dinem/relatorios/relatorio_aluno_tecnico_2022.xlsx')
    ...
    sh.cell(row= 25, column= 4).value = (sh.cell(row= 25, column= 4).value).replace('relatorio1.estd_orientado', relatorio1.estudo_orientado)
    ...
    sh.cell(row= 28, column= 4).value = (sh.cell(row= 28, column= 4).value).replace('relatorio1.pj_vd', relatorio1.projeto_vida)
    sh.cell(row= 28, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 30, column= 4).value = (sh.cell(row= 30, column= 4).value).replace('relatorio1.form_tec_prof', relatorio1.formacao_tecnica)
    ...
    sh.cell(row= 25, column= 6).value = (sh.cell(row= 25, column= 6).value).replace('relatorio2.estd_orientado', relatorio2.estudo_orientado)
    ...
    sh.cell(row= 27, column= 6).value = (sh.cell(row= 27, column= 6).value).replace('relatorio2.espanhol', relatorio2.espanhol)
    sh.cell(row= 27, column= 6).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 28, column= 6).value = (sh.cell(row= 28, column= 6).value).replace('relatorio2.pj_vd', relatorio2.projeto_vida)
    sh.cell(row= 28, column= 6).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 30, column= 6).value = (sh.cell(row= 30, column= 6).value).replace('relatorio2.form_tec_prof', relatorio2.formacao_tecnica)
    ...
    sh.cell(row= 25, column= 8).value = (sh.cell(row= 25, column= 8).value).replace('relatorio3.estd_orientado', relatorio3.estudo_orientado)
    ...
    sh.cell(row= 29, column= 8).value = (sh.cell(row= 29, column= 8).value).replace('relatorio3.pos_medio', relatorio3.pos_medio)
    sh.cell(row= 29, column= 8).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 30, column= 8).value = (sh.cell(row= 30, column= 8).value).replace('relatorio3.form_tec_prof', relatorio3.formacao_tecnica)
    ...
    response['Content-Disposition'] = 'attachment; filename="Aluno Técnico.xlsx"'
