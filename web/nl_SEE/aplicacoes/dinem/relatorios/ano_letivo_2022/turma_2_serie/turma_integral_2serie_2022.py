...
def cabecalho_por_pagina(l, sh):
    #Linha 1 Cabeçalho
        ...
        sh.cell(row= l, column= 1).font = styles.Font(bold=True, name= 'Calibri', size= 14)
        ...
        sh.cell(row= l, column= 6).font = styles.Font(bold=True, name= 'Calibri', size= 14)
        ...
        sh.cell(row= l, column= 18).font = styles.Font(bold=True, name= 'Calibri', size= 14)
        ...
        sh.cell(row= l, column= 27).font = styles.Font(bold=True, name= 'Calibri', size= 14)
        ...
        sh.cell(row= l, column= 22).font = styles.Font(bold=True, name= 'Calibri', size= 14)
        ...
        sh.cell(row= l, column= 26).font = styles.Font(bold=True, name= 'Calibri', size= 14)
        ...
        for i in range(6, 26, 1):
            ...
            sh.cell(row= l, column= i).font = styles.Font(bold=True, name= 'Calibri', size= 14)
...
def turma_integral_2serie(request):
    ...
    wb = load_workbook(filename= str(settings.BASE_DIR) + '/aplicacoes/dinem/relatorios/ano_letivo_2022/turma_2_serie/turma_integral_2serie_2022.xlsx')
    sh = wb['Relatório Final-2ª Integral']
    ...
    for relatorio in relatorios:
        ...
        if relatorio.resultado == 'TRANSFERIDO':
            ...
            if relatorio.linguagens_tecnologias != '-':
                sh.cell(row= 8, column= 28).value = '240h'
                sh.cell(row= 8, column= 29).value = '240h'
            else:
                sh.cell(row= 8, column= 28).value = '-'
                sh.cell(row= 8, column= 29).value = '-'
            ...
            if relatorio.ciencias_humanas != '-':
                sh.cell(row= 8, column= 30).value = '240h'
                sh.cell(row= 8, column= 31).value = '240h'
            else:
                sh.cell(row= 8, column= 30).value = '-'
                sh.cell(row= 8, column= 31).value = '-'
            sh.cell(row= l, column= 30).value = relatorio.ciencias_humanas
            sh.cell(row= l, column= 31).value = relatorio.ciencias_humanas

            if relatorio.ciencias_natureza != '-':
                sh.cell(row= 8, column= 32).value = '240h'
                sh.cell(row= 8, column= 33).value = '240h'
            else:
                sh.cell(row= 8, column= 32).value = '-'
                sh.cell(row= 8, column= 33).value = '-'
            sh.cell(row= l, column= 32).value = relatorio.ciencias_natureza
            sh.cell(row= l, column= 33).value = relatorio.ciencias_natureza

            if relatorio.matematica_tecnologias != '-':
                sh.cell(row= 8, column= 34).value = '240h'
                sh.cell(row= 8, column= 35).value = '240h'
            else:
                sh.cell(row= 8, column= 35).value = '-'
                sh.cell(row= 8, column= 35).value = '-'
            sh.cell(row= l, column= 35).value = relatorio.matematica_tecnologias
            sh.cell(row= l, column= 35).value = relatorio.matematica_tecnologias

            sh.cell(row= l, column= 36).value = '-'
            sh.cell(row= l, column= 37).value = relatorio.formacao_tecnica
            ...
            if relatorio.resultado == 'APROVADO':
                ...
                resultado = 'RP'
            sh.cell(row= l, column= 38).value = resultado
    ...
    response['Content-Disposition'] = 'attachment; filename="Turma Integral 2ª Série.xlsx"'
