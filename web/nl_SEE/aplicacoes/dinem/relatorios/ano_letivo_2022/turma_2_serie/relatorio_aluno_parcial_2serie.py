...
def dados_aluno_parcial_2serie(request, id_aluno_turma):
    urls = str(settings.BASE_DIR)

    # Abre o arquivo pelo caminho do documento.
    wb = load_workbook(filename= urls + '/aplicacoes/dinem/relatorios/ano_letivo_2022/turma_2_serie/relatorio_aluno_parcial_2serie_2022.xlsx')
    ...
    sh.cell(row= 2, column= 1).font = styles.Font(name= 'Carlito', bold=True, size= 9)
    ...
    sh.cell(row= 15, column= 4).value = (sh.cell(row= 15, column= 4).value).replace('relatorio1.ingles', relatorio1.ingles)
    sh.cell(row= 15, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 16, column= 4).value = (sh.cell(row= 16, column= 4).value).replace('relatorio1.ed_fisica', relatorio1.ed_fisica)
    ...
    sh.cell(row= 18, column= 4).value = (sh.cell(row= 18, column= 4).value).replace('relatorio1.fisica', relatorio1.fisica)
    sh.cell(row= 18, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 19, column= 4).value = (sh.cell(row= 19, column= 4).value).replace('relatorio1.quimica', relatorio1.quimica)
    ...
    sh.cell(row= 27, column= 4).value = (sh.cell(row= 27, column= 4).value).replace('relatorio1.eletiva', relatorio1.eletiva)
    ...
    sh.cell(row= 16, column= 6).value = (sh.cell(row= 16, column= 6).value).replace('relatorio2.ed_fisica', relatorio2.ed_fisica)
    ...
    sh.cell(row= 18, column= 6).value = (sh.cell(row= 18, column= 6).value).replace('relatorio2.fisica', relatorio2.fisica)
    sh.cell(row= 18, column= 6).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 19, column= 6).value = (sh.cell(row= 19, column= 6).value).replace('relatorio2.quimica', relatorio2.quimica)
    ...
    sh.cell(row= 26, column= 6).value = (sh.cell(row= 26, column= 6).value).replace('relatorio2.espanhol', relatorio2.espanhol)
    ...
    sh.cell(row= 30, column= 6).value = (sh.cell(row= 30, column= 6).value).replace('relatorio2.ling_tec', relatorio2.linguagens_tecnologias)
    sh.cell(row= 30, column= 6).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio2.linguagens_tecnologias != '-':
        sh.cell(row= 30, column= 7).value = '240'
        sh.cell(row= 30, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    else:
        sh.cell(row= 30, column= 7).value = '-'
        sh.cell(row= 30, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')

    sh.cell(row= 31, column= 6).value = (sh.cell(row= 31, column= 6).value).replace('relatorio2.mat_tec', relatorio2.matematica_tecnologias)
    sh.cell(row= 31, column= 6).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio2.matematica_tecnologias != '-':
        sh.cell(row= 31, column= 7).value = '240'
    ...
    sh.cell(row= 32, column= 6).value = (sh.cell(row= 32, column= 6).value).replace('relatorio2.cien_nat', relatorio2.ciencias_natureza)
    sh.cell(row= 32, column= 6).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio2.ciencias_natureza != '-':
        sh.cell(row= 32, column= 7).value = '240'
        sh.cell(row= 32, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    else:
        sh.cell(row= 32, column= 7).value = '-'
        sh.cell(row= 32, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')

    sh.cell(row= 33, column= 6).value = (sh.cell(row= 33, column= 6).value).replace('relatorio2.cien_hum', relatorio2.ciencias_humanas)
    sh.cell(row= 33, column= 6).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio2.ciencias_humanas != '-':
        sh.cell(row= 33, column= 7).value = '240'
        sh.cell(row= 33, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    else:
        sh.cell(row= 33, column= 7).value = '-'
        sh.cell(row= 33, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')

    sh.cell(row= 34, column= 6).value = (sh.cell(row= 34, column= 6).value).replace('relatorio2.form_prof', relatorio2.formacao_tecnica)
    sh.cell(row= 34, column= 6).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio2.formacao_tecnica != '-':
        sh.cell(row= 34, column= 7).value = '480'
    ...
    response['Content-Disposition'] = 'attachment; filename="Aluno Parcial 2ª Série.xlsx"'
