...
def turma_parcial_terceiro(request):
    ...
    wb = load_workbook(filename= str(settings.BASE_DIR) + '/aplicacoes/dinem/relatorios/turma_parcial_terceiro_2022.xlsx')
    ...
    for relatorio in relatorios:
        ...
        if relatorio.resultado == 'TRANSFERIDO':
            ...
            sh.cell(row= l, column= 23).value = relatorio.ciencias_humanas
