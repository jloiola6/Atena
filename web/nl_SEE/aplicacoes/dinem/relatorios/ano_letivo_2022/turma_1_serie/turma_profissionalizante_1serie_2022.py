...
def turma_profissionalizante_1serie(request):
    ...
    wb = load_workbook(filename= str(settings.BASE_DIR) + '/aplicacoes/dinem/relatorios/ano_letivo_2022/turma_1_serie/turma_profissionalizante_1serie_2022.xlsx')
    sh = wb['Relatório Final-1ª Tecnico']
    ...
    response['Content-Disposition'] = 'attachment; filename="Turma Profissionalizante 1ª Série.xlsx"'
