...
from aplicacoes.administracao.models import Endereco, Escola, Contato, Turmas, Grade, Gestor_Escolar
...
def relatorio_aluno(request):
    wb = load_workbook(filename= '/home/suporte/nl_SEE/aplicacoes/dinem/relatorios/relatorio_aluno.xlsx')
    sh = wb['Table 1']

    aluno = Aluno.objects.get(id= request.GET.get('id'))
    ...
    #Dados da escola
    sh.cell(row= 2, column= 1).value = (sh.cell(row= 2, column= 1).value).replace('NOME DA ESCOLA', escola.nome_escola)
    ...
    # sh.cell(row= 1, column= 1).value = (sh.cell(row= 1, column= 1).value).replace('Telefone', contato[0].contato)
    # sh.cell(row= 2, column= 1).value = (sh.cell(row= 2, column= 1).value).replace('e-mail', contato.email)
    ...
    sh.cell(row= 6, column= 1).value = (sh.cell(row= 6, column= 1).value).replace('aluno.data', aluno.nascimento)
    sh.cell(row= 6, column= 1).font = styles.Font(name= 'Arial', size= 7)

    sh.cell(row= 6, column= 11).value = (sh.cell(row= 6, column= 11).value).replace('aluno.nacionalidade', 'aluno.nacionalidade')
    sh.cell(row= 6, column= 11).font = styles.Font(name= 'Arial', size= 7)

    sh.cell(row= 6, column= 17).value = (sh.cell(row= 6, column= 17).value).replace('aluno.uf', 'aluno.uf')
    ...
    sh.cell(row= 31, column= 16).value = (sh.cell(row= 31, column= 16).value).replace('relatorio3.IC', relatorio3.investigacao)
    sh.cell(row= 31, column= 16).alignment = styles.Alignment(horizontal='center', vertical= 'center')

    sh.cell(row= 32, column= 16).value = (sh.cell(row= 32, column= 16).value).replace('relatorio3.PC', relatorio3.criativos)
    sh.cell(row= 32, column= 16).alignment = styles.Alignment(horizontal='center', vertical= 'center')

    sh.cell(row= 33, column= 16).value = (sh.cell(row= 33, column= 16).value).replace('relatorio3.MIS', relatorio3.sociocultural)
    sh.cell(row= 33, column= 16).alignment = styles.Alignment(horizontal='center', vertical= 'center')

    sh.cell(row= 34, column= 16).value = (sh.cell(row= 34, column= 16).value).replace('relatorio3.EMP', relatorio3.empreendedorismo)
    ...
    if relatorio3.investigacao == '-':
        ...
        sh.cell(row= 33, column= 3).value = (sh.cell(row= 33, column= 3).value).replace('area_conhecimento', '-')
        sh.cell(row= 33, column= 3).alignment = styles.Alignment(horizontal='center', vertical= 'center')
        
        sh.cell(row= 31, column= 18).value = '-'
        sh.cell(row= 31, column= 18).alignment = styles.Alignment(horizontal='center', vertical= 'center')
        ...
        sh.cell(row= 37, column= 10).value = (sh.cell(row= 37, column= 10).value).replace('total1', total1)
        sh.cell(row= 37, column= 10).alignment = styles.Alignment(horizontal='center', vertical= 'center')
        
        sh.cell(row= 38, column= 10).value = (sh.cell(row= 38, column= 10).value).replace('total2', total2)
        ...
        sh.cell(row= 33, column= 3).value = (sh.cell(row= 33, column= 3).value).replace('area_conhecimento', relatorio3.area_conhecimento)
        sh.cell(row= 33, column= 3).alignment = styles.Alignment(horizontal='center', vertical= 'center')
        sh.cell(row= 33, column= 3).font = styles.Font(name= 'Carlito', size= 6)
    ...
    for i in range(42, 45, 1):   
        sh.cell(row= i, column= 4).value = (sh.cell(row= i, column= 4).value).replace('NOME DA ESCOLA', escola.nome_escola)
        sh.cell(row= i, column= 4).alignment = styles.Alignment(horizontal='center', vertical= 'center')
        sh.cell(row= i, column= 4).font = styles.Font(name= 'Carlito', size= 9)
