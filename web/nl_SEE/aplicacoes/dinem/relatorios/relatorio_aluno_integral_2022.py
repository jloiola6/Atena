...
def dados_aluno_integral(request, id_aluno_turma):
    urls = str(settings.BASE_DIR)

    # Abre o arquivo pelo caminho do documento.
    wb = load_workbook(filename= urls + '/aplicacoes/dinem/relatorios/relatorio_aluno_integral_2022.xlsx')
    ...
    relatorio1 = RelatorioFinal.objects.get(aluno= aluno.id, etapa= '1ª Série', turma= turma)
    relatorio2 = RelatorioFinal.objects.get(aluno= aluno.id, etapa= '2ª Série', turma= turma)
    relatorio3 = RelatorioFinal.objects.get(aluno= aluno.id, etapa= '3ª Série', turma= turma)
    ...
    sh.cell(row= 12, column= 4).value = (sh.cell(row= 12, column= 4).value).replace('relatorio1.ingles', relatorio1.ingles)
    sh.cell(row= 12, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 13, column= 4).value = (sh.cell(row= 13, column= 4).value).replace('relatorio1.ed_fisica', relatorio1.ed_fisica)
    sh.cell(row= 13, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 14, column= 4).value = (sh.cell(row= 14, column= 4).value).replace('relatorio1.artes', relatorio1.arte)
    sh.cell(row= 14, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 15, column= 4).value = (sh.cell(row= 15, column= 4).value).replace('relatorio1.matematica', relatorio1.matematica)
    sh.cell(row= 15, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 16, column= 4).value = (sh.cell(row= 16, column= 4).value).replace('relatorio1.quimica', relatorio1.quimica)
    sh.cell(row= 16, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 17, column= 4).value = (sh.cell(row= 17, column= 4).value).replace('relatorio1.fisica', relatorio1.fisica)
    ...
    sh.cell(row= 24, column= 4).value = (sh.cell(row= 24, column= 4).value).replace('relatorio1.eletiva', relatorio1.eletiva)
    sh.cell(row= 24, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 25, column= 4).value = (sh.cell(row= 25, column= 4).value).replace('relatorio1.est_orient', relatorio1.estudo_orientado)
    sh.cell(row= 25, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 26, column= 4).value = (sh.cell(row= 26, column= 4).value).replace('relatorio1.prat_exp', relatorio1.praticas_experimentais)
    sh.cell(row= 26, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 29, column= 4).value = (sh.cell(row= 29, column= 4).value).replace('relatorio1.pj_vd', relatorio1.projeto_vida)
    sh.cell(row= 29, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 30, column= 4).value = (sh.cell(row= 30, column= 4).value).replace('relatorio1.ofic_ling', relatorio1.oficina_linguagens)
    sh.cell(row= 30, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 31, column= 4).value = (sh.cell(row= 31, column= 4).value).replace('relatorio1.ofic_mat', relatorio1.oficina_matematica)
    sh.cell(row= 31, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 32, column= 4).value = (sh.cell(row= 32, column= 4).value).replace('relatorio1.ofic_natureza', relatorio1.oficina_natureza)
    sh.cell(row= 32, column= 4).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 33, column= 4).value = (sh.cell(row= 33, column= 4).value).replace('relatorio1.ofic_humanas', relatorio1.oficina_humanas)
    sh.cell(row= 33, column= 4).font = styles.Font(name= 'Calibri', size= 9)
    ...
    sh.cell(row= 13, column= 6).value = (sh.cell(row= 13, column= 6).value).replace('relatorio2.ed_fisica', relatorio2.ed_fisica)
    ...
    sh.cell(row= 16, column= 6).value = (sh.cell(row= 16, column= 6).value).replace('relatorio2.quimica', relatorio2.quimica)
    sh.cell(row= 16, column= 6).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 17, column= 6).value = (sh.cell(row= 17, column= 6).value).replace('relatorio2.fisica', relatorio2.fisica)
    ...
    sh.cell(row= 25, column= 6).value = (sh.cell(row= 25, column= 6).value).replace('relatorio2.est_orient', relatorio2.estudo_orientado)
    sh.cell(row= 25, column= 6).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 28, column= 6).value = (sh.cell(row= 28, column= 6).value).replace('relatorio2.espanhol', relatorio2.espanhol)
    sh.cell(row= 28, column= 6).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 29, column= 6).value = (sh.cell(row= 29, column= 6).value).replace('relatorio2.pj_vd', relatorio2.projeto_vida)
    sh.cell(row= 29, column= 6).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 26, column= 6).value = (sh.cell(row= 26, column= 6).value).replace('relatorio2.prat_exp', relatorio2.praticas_experimentais)
    sh.cell(row= 26, column= 6).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 34, column= 6).value = (sh.cell(row= 34, column= 6).value).replace('relatorio2.ling_tec', relatorio2.linguagens_tecnologias)
    sh.cell(row= 34, column= 6).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio2.linguagens_tecnologias != '-':
        sh.cell(row= 34, column= 7).value = '240'
        sh.cell(row= 34, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    else:
        sh.cell(row= 34, column= 7).value = '-'
        sh.cell(row= 34, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')

    sh.cell(row= 35, column= 6).value = (sh.cell(row= 35, column= 6).value).replace('relatorio2.mat_tec', relatorio2.matematica_tecnologias)
    sh.cell(row= 35, column= 6).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio2.matematica_tecnologias != '-':
        sh.cell(row= 35, column= 7).value = '240'
        sh.cell(row= 35, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    else:
        sh.cell(row= 35, column= 7).value = '-'
        sh.cell(row= 35, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')


    sh.cell(row= 36, column= 6).value = (sh.cell(row= 36, column= 6).value).replace('relatorio2.cien_nat', relatorio2.ciencias_natureza)
    sh.cell(row= 36, column= 6).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio2.ciencias_natureza != '-':
        sh.cell(row= 36, column= 7).value = '240'
        sh.cell(row= 36, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    else:
        sh.cell(row= 36, column= 7).value = '-'
        sh.cell(row= 36, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')

    sh.cell(row= 37, column= 6).value = (sh.cell(row= 37, column= 6).value).replace('relatorio2.cien_hum', relatorio2.ciencias_humanas)
    sh.cell(row= 37, column= 6).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio2.ciencias_humanas != '-':
        sh.cell(row= 37, column= 7).value = '240'
        sh.cell(row= 37, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    else:
        sh.cell(row= 37, column= 7).value = '-'
        sh.cell(row= 37, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')

    sh.cell(row= 38, column= 6).value = (sh.cell(row= 38, column= 6).value).replace('relatorio2.form_prof', relatorio2.formacao_tecnica)
    sh.cell(row= 38, column= 6).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio2.formacao_tecnica != '-':
        sh.cell(row= 38, column= 7).value = '480'
        sh.cell(row= 38, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    else:
        sh.cell(row= 38, column= 7).value = '-'
        sh.cell(row= 38, column= 7).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    ...
    sh.cell(row= 13, column= 8).value = (sh.cell(row= 13, column= 8).value).replace('relatorio3.ed_fisica', relatorio3.ed_fisica)
    sh.cell(row= 13, column= 8).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 25, column= 8).value = (sh.cell(row= 25, column= 8).value).replace('relatorio3.est_orient', relatorio3.estudo_orientado)
    sh.cell(row= 25, column= 8).font = styles.Font(name= 'Calibri', size= 9)

    sh.cell(row= 26, column= 8).value = (sh.cell(row= 26, column= 8).value).replace('relatorio3.prat_exp', relatorio3.praticas_experimentais)
    sh.cell(row= 26, column= 8).font = styles.Font(name= 'Calibri', size= 9)
    ...
    sh.cell(row= 34, column= 8).value = (sh.cell(row= 34, column= 8).value).replace('relatorio3.ling_tec', relatorio3.linguagens_tecnologias)
    sh.cell(row= 34, column= 8).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio3.linguagens_tecnologias != '-':
        sh.cell(row= 34, column= 9).value = '440'
        sh.cell(row= 34, column= 9).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    else:
        sh.cell(row= 34, column= 9).value = '-'
        sh.cell(row= 34, column= 9).alignment = styles.Alignment(horizontal='center', vertical= 'center')

    sh.cell(row= 35, column= 8).value = (sh.cell(row= 35, column= 8).value).replace('relatorio3.mat_tec', relatorio3.matematica_tecnologias)
    sh.cell(row= 35, column= 8).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio3.matematica_tecnologias != '-':
        sh.cell(row= 35, column= 9).value = '440'
        sh.cell(row= 35, column= 9).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    else:
        sh.cell(row= 35, column= 9).value = '-'
        sh.cell(row= 35, column= 9).alignment = styles.Alignment(horizontal='center', vertical= 'center')

    sh.cell(row= 36, column= 8).value = (sh.cell(row= 36, column= 8).value).replace('relatorio3.cien_nat', relatorio3.ciencias_natureza)
    sh.cell(row= 36, column= 8).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio3.ciencias_natureza != '-':
        sh.cell(row= 36, column= 9).value = '440'
        sh.cell(row= 36, column= 9).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    else:
        sh.cell(row= 36, column= 9).value = '-'
        sh.cell(row= 36, column= 9).alignment = styles.Alignment(horizontal='center', vertical= 'center')

    sh.cell(row= 37, column= 8).value = (sh.cell(row= 37, column= 8).value).replace('relatorio3.cien_hum', relatorio3.ciencias_humanas)
    sh.cell(row= 37, column= 8).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio3.ciencias_humanas != '-':
        sh.cell(row= 37, column= 9).value = '440'
        sh.cell(row= 37, column= 9).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    else:
        sh.cell(row= 37, column= 9).value = '-'
        sh.cell(row= 37, column= 9).alignment = styles.Alignment(horizontal='center', vertical= 'center')

    sh.cell(row= 38, column= 8).value = (sh.cell(row= 38, column= 8).value).replace('relatorio3.form_prof', relatorio3.formacao_tecnica)
    sh.cell(row= 38, column= 8).font = styles.Font(name= 'Calibri', size= 9)
    if relatorio3.formacao_tecnica != '-':
        sh.cell(row= 38, column= 9).value = '880'
        sh.cell(row= 38, column= 9).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    else:
        sh.cell(row= 38, column= 9).value = '-'
        sh.cell(row= 38, column= 9).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    ...
    response['Content-Disposition'] = 'attachment; filename="Aluno Integral.xlsx"'
