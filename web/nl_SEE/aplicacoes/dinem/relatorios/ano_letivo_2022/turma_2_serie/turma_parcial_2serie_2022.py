...
def turma_parcial_2serie(request):
    ...
    wb = load_workbook(filename= str(settings.BASE_DIR) + '/aplicacoes/dinem/relatorios/ano_letivo_2022/turma_2_serie/turma_parcial_2serie_2022.xlsx')
    sh = wb['Relatório Final-Parcial-2ª']
    ...
    sh.cell(row= 8, column= 20).value = '80h'
    sh.cell(row= 8, column= 20).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    sh.cell(row= 8, column= 31).value = '600h'
    sh.cell(row= 8, column= 31).alignment = styles.Alignment(horizontal='center', vertical= 'center')
    ...
    for relatorio in relatorios:
        ...
        if relatorio.resultado == 'TRANSFERIDO':
            ...
            sh.cell(row= l, column= 11).value = relatorio.quimica
            sh.cell(row= l, column= 12).value = relatorio.fisica
            ...
            sh.cell(row= l, column= 18).value = relatorio.espanhol
            sh.cell(row= l, column= 19).value = '-'
            sh.cell(row= l, column= 20).value = relatorio.projeto_vida
            sh.cell(row= l, column= 21).value = '-'
            sh.cell(row= l, column= 22).value = relatorio.linguagens_tecnologias
            sh.cell(row= l, column= 23).value = relatorio.linguagens_tecnologias
            sh.cell(row= l, column= 24).value = relatorio.ciencias_humanas
            sh.cell(row= l, column= 25).value = relatorio.ciencias_humanas
            sh.cell(row= l, column= 26).value = relatorio.ciencias_natureza
            sh.cell(row= l, column= 27).value = relatorio.ciencias_natureza
            sh.cell(row= l, column= 28).value = relatorio.matematica_tecnologias
            sh.cell(row= l, column= 29).value = relatorio.matematica_tecnologias
            sh.cell(row= l, column= 30).value = '-'
            sh.cell(row= l, column= 31).value = relatorio.formacao_tecnica
            ...
            if relatorio.resultado == 'APROVADO':
                ...
                resultado = 'RP'
            sh.cell(row= l, column= 32).value = resultado
    ...
    response['Content-Disposition'] = 'attachment; filename="Turma Parcial 2ª Série.xlsx"'
